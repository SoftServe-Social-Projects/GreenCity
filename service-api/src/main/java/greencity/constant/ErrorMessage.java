...
public class ErrorMessage {
    ...
    public static final String USER_TO_DO_LIST_ITEMS_NOT_RELATED_TO_PROVIDED_HABIT_ASSIGN = "Provided user to-do list item and habit assign not related to each other";
